...
chrome.contextMenus.onClicked.addListener( function( info, targetTab )
{
	...
	let confirmDialogue = `New Domain in New Tab requires a page reload in order to completely reset links. Without a reload, new domain links that have already been visited will still open in a new tab ( though unvisited links should revert to their original behavior ).
					\nReload the page now?`;
